...
insert into comment (news_id, author, text)
values  (1, 'John Doe', 'This is unbelievable!'),
        (1, 'Jane Smith', 'I am shocked!'),
        (2, 'Alice Johnson', 'Can’t wait to try out this new gadget.'),
        (2, '', 'Looks cool, but too expensive.');